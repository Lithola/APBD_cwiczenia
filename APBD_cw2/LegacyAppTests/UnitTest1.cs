...
public class AddUserTest
{
    ...
    [Fact]
    public void UserAdd_Should_Return_False_When_Wrong_Email()
    {
        // Arrange
        string firstName = "John";
        string lastName = "Doe";
    ...
    [Fact]
    public void UserAdd_Should_Return_False_When_Age_Too_Low()
    {
        // Arrange
        string firstName = "John";
        string lastName = "Doe";
        string email = "johndoe@gmail.com";
        var dateofBirth = new DateTime(2008, 03, 21);
        int clientId = 1;
    ...
    [Fact]
    public void UserAdd_Should_Return_True_When_All_Correct()
    {
        // Arrange
        string firstName = "John";
        string lastName = "Doe";
